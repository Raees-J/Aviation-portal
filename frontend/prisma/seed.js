...
async function main() {
  ...
  // Create aircraft
  const aircraft = [
    { registration: 'ZS-OHH', model: 'C172 N', type: 'C172', totalHours: 4523.5, maintenanceHours: 4350, nextMaintenance: 4600, status: 'AVAILABLE' },
    { registration: 'ZS-OHI', model: 'C172 N', type: 'C172', totalHours: 3812.2, maintenanceHours: 3700, nextMaintenance: 3900, status: 'AVAILABLE' },
    { registration: 'ZS-SLM', model: 'C172 P', type: 'C172', totalHours: 2156.8, maintenanceHours: 2050, nextMaintenance: 2250, status: 'AVAILABLE' },
    { registration: 'ZS-SMS', model: 'C172 R', type: 'C172', totalHours: 1892.4, maintenanceHours: 1800, nextMaintenance: 2000, status: 'AVAILABLE' },
    { registration: 'ZS-KUI', model: 'C172RG Cutlass', type: 'C172RG', totalHours: 5234.1, maintenanceHours: 5100, nextMaintenance: 5300, status: 'MAINTENANCE' },
  ];
